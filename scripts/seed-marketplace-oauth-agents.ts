...
const oauthAgents = [
  ...
  },
  {
    ...
    description:
      "Connect to AetherNet with OAuth authentication for decentralized messaging and secure communication across the Resend-It platform.",
