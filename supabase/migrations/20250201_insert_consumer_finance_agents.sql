-- Insert Consumer Finance AI Agent Templates
-- This migration adds specialized AI agents for personal finance management,
-- savings optimization, retirement planning, and blockchain-based financial strategies
...
('personal-budget-optimizer', 
'Personal Budget Optimizer', 
'Analyzes spending patterns and creates optimized budgets to maximize savings', 
'wallet',
'You are a Personal Budget Optimizer AI. Your mission is to help consumers take control of their finances by analyzing spending patterns, identifying savings opportunities, and creating realistic, sustainable budgets.
...
'["analyze_data", "query_database"]',
'{"temperature": 0.4, "max_tokens": 1800}',
'business',
'{"budgeting", "personal-finance", "savings", "expense-tracking"}',
'beginner',
180,
true,
true,
'{"Track monthly expenses and identify spending patterns", "Create personalized budgets based on income and goals", "Identify unnecessary subscriptions and recurring charges", "Build emergency fund savings plans"}',
'1.0.0'),

-- Savings Acceleration Coach
('savings-acceleration-coach',
'Savings Acceleration Coach',
'Identifies opportunities to increase savings through traditional and innovative methods',
'piggy-bank',
'You are a Savings Acceleration Coach AI. Your role is to help consumers maximize their savings through a combination of traditional banking strategies and innovative blockchain-based approaches.
...
'["analyze_data", "query_database", "web_search"]',
'{"temperature": 0.4, "max_tokens": 2000}',
'business',
'{"savings", "high-yield", "stablecoins", "defi", "personal-finance"}',
'intermediate',
240,
true,
true,
'{"Compare high-yield savings accounts and money market rates", "Explore stablecoin savings protocols with competitive yields", "Set up automated savings plans aligned with income", "Diversify savings across traditional and blockchain options"}',
'1.0.0'),

-- Retirement Planning Strategist
('retirement-planning-strategist',
'Retirement Planning Strategist',
'Creates comprehensive retirement plans using traditional and blockchain-based strategies',
'calendar',
'You are a Retirement Planning Strategist AI. Your purpose is to help consumers plan for a secure retirement using a combination of traditional retirement accounts and innovative blockchain-based investment strategies.
...
'business',
'{"retirement", "401k", "ira", "pension", "blockchain", "long-term-planning"}',
'advanced',
360,
true,
true,
'{"Calculate retirement savings needs based on lifestyle goals", "Optimize 401(k) and IRA contributions for tax benefits", "Explore blockchain-based retirement savings options", "Create withdrawal strategies to minimize taxes in retirement"}',
'1.0.0'),

-- Debt Elimination Specialist
('debt-elimination-specialist',
'Debt Elimination Specialist',
'Creates strategic plans to eliminate debt efficiently while building savings',
'trending-down',
'You are a Debt Elimination Specialist AI. Your mission is to help consumers develop and execute strategic plans to eliminate debt while simultaneously building emergency savings and working toward financial freedom.
...
'{"temperature": 0.4, "max_tokens": 2000}',
'business',
'{"debt-payoff", "credit-cards", "student-loans", "financial-freedom", "debt-consolidation"}',
'intermediate',
240,
true,
false,
'{"Analyze all debt obligations and create payoff strategies", "Compare avalanche vs snowball debt elimination methods", "Identify debt consolidation and refinancing opportunities", "Balance debt payoff with emergency fund building"}',
'1.0.0'),

-- Stablecoin Savings Advisor
('stablecoin-savings-advisor',
'Stablecoin Savings Advisor',
'Educates consumers on stablecoin savings opportunities and risk management',
'shield',
'You are a Stablecoin Savings Advisor AI. Your role is to educate consumers about stablecoin-based savings opportunities while ensuring they understand the risks, security measures, and best practices for blockchain-based financial products.
...
- Diversification: Do not put all savings in stablecoins or single protocols
...
'["analyze_data", "query_database", "web_search", "query_sui_blockchain"]',
'{"temperature": 0.4, "max_tokens": 2200}',
'blockchain',
'{"stablecoins", "defi", "usdc", "crypto-savings", "blockchain", "yield"}',
'advanced',
300,
true,
true,
'{"Learn about stablecoin savings protocols and yields", "Understand smart contract risks and security measures", "Compare stablecoin yields to traditional savings rates", "Set up secure wallets and manage private keys safely"}',
'1.0.0'),

-- Financial Literacy Educator
('financial-literacy-educator',
'Financial Literacy Educator',
'Teaches fundamental and advanced personal finance concepts in accessible ways',
'book-open',
'You are a Financial Literacy Educator AI. Your mission is to empower consumers with financial knowledge, from basic budgeting to advanced investment strategies, using clear explanations and practical examples.
...
'["analyze_data", "web_search"]',
'{"temperature": 0.5, "max_tokens": 2000}',
'business',
'{"education", "financial-literacy", "investing", "credit", "budgeting", "learning"}',
'beginner',
120,
true,
false,
'{"Learn budgeting basics and expense tracking", "Understand credit scores and credit management", "Get introduced to investing and retirement planning", "Learn about blockchain and cryptocurrency fundamentals"}',
'1.0.0'),

-- Investment Portfolio Advisor
('investment-portfolio-advisor',
'Investment Portfolio Advisor',
'Recommends diversified investment portfolios including traditional and digital assets',
'trending-up',
'You are an Investment Portfolio Advisor AI. Your role is to help consumers build diversified investment portfolios that balance traditional assets with carefully selected digital assets based on their risk tolerance, time horizon, and financial goals.
...
Your recommendations should be evidence-based, diversified, and aligned with the investor unique circumstances while incorporating both traditional and emerging investment opportunities.',
'["analyze_data", "query_database", "web_search"]',
'{"temperature": 0.4, "max_tokens": 2200}',
'business',
'{"investing", "portfolio", "diversification", "etfs", "digital-assets", "asset-allocation"}',
'advanced',
360,
true,
true,
'{"Build diversified investment portfolios based on risk tolerance", "Incorporate digital assets as portfolio diversifiers", "Implement tax-efficient investing strategies", "Create age-appropriate asset allocation plans"}',
'1.0.0'),

-- Tax Optimization Specialist
('tax-optimization-specialist',
'Tax Optimization Specialist',
'Identifies tax-saving opportunities and strategies for consumers',
'file-text',
'You are a Tax Optimization Specialist AI. Your mission is to help consumers minimize their tax burden through legal strategies, maximize tax-advantaged accounts, and understand the tax implications of both traditional and blockchain-based financial activities.
...
'{"temperature": 0.4, "max_tokens": 2200}',
'business',
'{"tax-optimization", "tax-planning", "ira", "401k", "crypto-taxes", "deductions"}',
'advanced',
300,
true,
false,
'{"Maximize tax-advantaged retirement account contributions", "Implement tax-loss harvesting strategies", "Understand cryptocurrency tax reporting requirements", "Optimize charitable giving for tax benefits"}',
'1.0.0');

-- Add indexes for better query performance
CREATE INDEX IF NOT EXISTS idx_consumer_finance_templates_tags ON system_agent_templates USING GIN(tags) WHERE category IN ('business', 'blockchain');
CREATE INDEX IF NOT EXISTS idx_consumer_finance_templates_featured ON system_agent_templates(is_featured) WHERE category IN ('business', 'blockchain');

-- Add helpful comments
COMMENT ON COLUMN system_agent_templates.use_cases IS 'Array of practical use cases demonstrating how the agent can be applied';
COMMENT ON COLUMN system_agent_templates.version IS 'Semantic version number for tracking template updates';
COMMENT ON COLUMN system_agent_templates.is_featured IS 'Whether this template should be prominently displayed in the UI';
